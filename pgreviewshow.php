...
<body style="background-color: lightblue">
	...
	<?php
		...
		if(isset($_COOKIE["userid"])){
		    ...
		    $sql = "SELECT  * FROM `pgreview` WHERE `pg_email` = '$messem'";
		    ...
		    if($result->num_rows > 0){
		    	...
		    	<div class="card-body text-center bg-primary text-light">
				 ...
				 <ul class="list-group list-group-flush">
				    <li class="list-group-item"> Cleanliness : '.$row['CLEANLINESS'].'</li>
				    
				  </ul>
				  <ul class="list-group list-group-flush">
				    <li class="list-group-item">Comfort : <b>'.$row['COMFORT'].'</b></li>
				    <li class="list-group-item">Location : <b>'.$row['LOCATION'].'</b></li>
				<li class="list-group-item">Staff: <b>'.$row['STAFF'].'</b></li>
				<li class="list-group-item">Facilities : <b>'.$row['FACILITIES'].'</b></li>
				  </ul>
