...
<body>
    <nav class="navbar navbar-light bg-secondary">
      <div class="container-fluid">
        <span class="navbar-brand mb-0 h1  text-light ps-4">Registered Room</span>
      </div>
    </nav>
    <br><br>
</body>
...
$name=$_POST['pgname'];
   ...
   /*$messem = $_COOKIE['userid'];
    ...
    $sql1 = "INSERT INTO `pgrooms`(`pg_name`, `capacity`,`room_type`, `pg_id`, `price`) VALUES ('$name','$room_capacity','$type','$id','$price')";
